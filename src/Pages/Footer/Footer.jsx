...
const navLinks = [
  ...
  { label: "Marbles", href: "/marble" },
  { label: "Imported Marbles", href: "/imported-marble" },
  { label: "Granites", href: "/granites" },
  { label: "Tiles", href: "/tiles" },
  { label: "Sandstones", href: "/sandstone" },
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.associatedSection}>
        ...
        <ul className={styles.associatedList}>
          <li>
            PRIYA MARBLES <span className={styles.pipe}>|</span>
          </li>
          <li>
            AKSHAY MARBLE SUPPLIERS <span className={styles.pipe}>|</span>
          </li>
          <li>
            SHRI KRISHNA STONEX <span className={styles.pipe}>|</span>
          </li>
          <li>
            SHUBHAM MARBLES <span className={styles.pipe}>|</span>
          </li>
          <li>
            MONU MARBLES <span className={styles.pipe}>|</span>
          </li>
        </ul>
      </div>
